require('abilities/base_ability_charges')
LinkLuaModifier("modifier_vengefulspirit_nether_swap_redux_charges","abilities/vengefulspirit_nether_swap.lua",LUA_MODIFIER_MOTION_NONE)
---@class vengeful_nether_swap_lua : CDOTA_Ability_Lua
vengefulspirit_nether_swap_redux = class(base_ability_charges)
modifier_vengefulspirit_nether_swap_redux_charges = class(modifier_base_ability_charges)

---@override
function vengefulspirit_nether_swap_redux:CastFilterResultTarget(hTarget)
...
---@override
function vengefulspirit_nether_swap_redux:GetCustomCastErrorTarget(hTarget)
    if self:GetCaster() == hTarget then
...
---@override
function vengefulspirit_nether_swap_redux:OnSpellStart()
